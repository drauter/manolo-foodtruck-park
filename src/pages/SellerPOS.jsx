...
const SellerPOS = ({ isEmbedded = false, embeddedStation = null }) => {
  ...
  return (
    <div className={`${isEmbedded ? 'h-full absolute inset-0' : 'min-h-screen lg:h-screen'} bg-transparent text-slate-900 flex flex-col lg:flex-row overflow-x-hidden lg:overflow-hidden font-sans no-print`}>
